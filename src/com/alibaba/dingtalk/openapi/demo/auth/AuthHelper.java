...
public class AuthHelper {
	...
	public static String getAccessCode() throws OApiException {
		String url = Env.OAPI_HOST + "/connect/oauth2/authorize?" 
									+ "appid=" + Env.CORP_ID 
									+ "&redirect_uri=" + Env.CUrl 
									+ "&response_type=code" 
									+ "&scope=snsapi_base" 
									+ "&state=" + Env.CORP_State;
		...
		if (response.containsKey("code")) {
			...
			throw new OApiResultException("code");
		}
	}
	...
	public static String getConfig(String urlString, String queryString) {
		...
		return "{signature:'" + signature + "',nonceStr:'" + nonceStr
				+ "',timeStamp:'" + timeStamp + "',corpId:'" + Env.CORP_ID
				+ "'}";
	}
}
