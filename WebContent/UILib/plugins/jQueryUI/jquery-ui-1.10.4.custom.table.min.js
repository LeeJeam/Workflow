...
(function (t, e) {
    ...
    t.ui = t.ui || {}, t.extend(t.ui, {
        ...
        var n = "Width" === s ? ["Left", "Right"] : ["Top", "Bottom"], r = s.toLowerCase(), a = {
        ...
        plugin: {
            add: function (e, i, s) {
                ...
                var s, o = t.plugins[e];
                if (o && t.element[0].parentNode && 11 !== t.element[0].parentNode.nodeType)for (s = 0; o.length > s; s++)t.options[o[s][0]] && o[s][1].apply(t.element, i)
            }
...
(function (t, e) {
    ...
    t.ui = t.ui || {};
    var o, a = Math.max, r = Math.abs, l = Math.round, h = /left|center|right/, c = /top|center|bottom/, u = /[\+\-]\d+(\.[\d]+)?%?/, d = /^\w+/, p = /%$/, f = t.fn.position;
    t.position = {
        ...
        return _ = n(b), b[0].preventDefault && (e.at = "left top"), p = _.width, g = _.height, m = _.offset, v = t.extend({}, m), t.each(["my", "at"], function () {
            ...
            1 === s.length && (s = h.test(s[0]) ? s.concat(["center"]) : c.test(s[0]) ? ["center"].concat(s) : ["center", "center"]), s[0] = h.test(s[0]) ? s[0] : "center", s[1] = c.test(s[1]) ? s[1] : "center", t = u.exec(s[0]), i = u.exec(s[1]), x[this] = [t ? t[0] : 0, i ? i[0] : 0], e[this] = [d.exec(s[0])[0], d.exec(s[1])[0]]
            ...
            var n, h, c = t(this), u = c.outerWidth(), d = c.outerHeight(), f = s(this, "marginLeft"), _ = s(this, "marginTop"), D = u + f + s(this, "marginRight") + w.width, C = d + _ + s(this, "marginBottom") + w.height, P = t.extend({}, v), T = i(x.my, c.outerWidth(), c.outerHeight());
            "right" === e.my[0] ? P.left -= u : "center" === e.my[0] && (P.left -= u / 2), "bottom" === e.my[1] ? P.top -= d : "center" === e.my[1] && (P.top -= d / 2), P.left += T[0], P.top += T[1], t.support.offsetFractions || (P.left = l(P.left), P.top = l(P.top)), n = {
                marginLeft: f,
                marginTop: _
                ...
                var i = m.left - P.left, s = i + p - u, n = m.top - P.top, o = n + g - d, l = {
                    target: {
                        element: b,
                        left: m.left,
                        top: m.top,
        ...
        fit: {
            ...
            left: function (t, e) {
                ...
                0 > c ? (s = t.top + p + f + g + e.collisionHeight - a - o, t.top + p + f + g > c && (0 > s || r(c) > s) && (t.top += p + f + g)) : u > 0 && (i = t.top - e.collisionPosition.marginTop + p + f + g - l, t.top + p + f + g > u && (i > 0 || u > r(i)) && (t.top += p + f + g))
            }
        }, flipfit: {
            left: function () {
...
(function (t) {
    t.widget("ui.draggable", t.ui.mouse, {
        ...
        start: function () {
            ...
            var s, n, o, a, r, l, h, c, u, d, p = t(this).data("ui-draggable"), f = p.options, g = f.snapTolerance, m = i.offset.left, v = m + p.helperProportions.width, _ = i.offset.top, b = _ + p.helperProportions.height;
...
(function (t) {
    ...
    t.widget("ui.droppable", {
        ...
        var n, o, a = (t.positionAbs || t.position.absolute).left, r = (t.positionAbs || t.position.absolute).top, l = a + t.helperProportions.width, h = r + t.helperProportions.height, c = i.offset.left, u = i.offset.top, d = c + i.proportions().width, p = u + i.proportions().height;
        switch (s) {
            case"fit":
...
(function (t) {
    ...
    t.widget("ui.resizable", t.ui.mouse, {
        ...
        _mouseDrag: function (e) {
            var i, s = this.helper, n = {}, o = this.originalMousePosition, a = this.axis, r = this.position.top, l = this.position.left, h = this.size.width, c = this.size.height, u = e.pageX - o.left || 0, d = e.pageY - o.top || 0, p = this._change[a];
        ...
        stop: function (e) {
            var i = t(this).data("ui-resizable"), s = i.options, n = i._proportionallyResizeElements, o = n.length && /textarea/i.test(n[0].nodeName), a = o && t.ui.hasScroll(n[0], "left") ? 0 : i.sizeDiff.height, r = o ? 0 : i.sizeDiff.width, l = {
        ...
        start: function () {
            var i, s, n, o, a, r, l, h = t(this).data("ui-resizable"), c = h.options, u = h.element, d = c.containment, p = d instanceof t ? d.get(0) : /parent/.test(d) ? u.parent().get(0) : d;
            ...
            var i, s, n, o, a = t(this).data("ui-resizable"), r = a.options, l = a.containerOffset, h = a.position, c = a._aspectRatio || e.shiftKey, u = {
                top: 0,
                left: 0
...
(function (t) {
    ...
    t.widget("ui.sortable", t.ui.mouse, {
        ...
        _generatePosition: function (e) {
            var i, s, n = this.options, o = e.pageX, a = e.pageY, r = "absolute" !== this.cssPosition || this.scrollParent[0] !== document && t.contains(this.scrollParent[0], this.offsetParent[0]) ? this.scrollParent : this.offsetParent, l = /(html|body)/i.test(r[0].tagName);
    ...
    i.height = i.paddingTop = i.paddingBottom = i.borderTopWidth = i.borderBottomWidth = "hide", s.height = s.paddingTop = s.paddingBottom = s.borderTopWidth = s.borderBottomWidth = "show", t.widget("ui.accordion", {
        ...
        _keydown: function (e) {
            if (!e.altKey && !e.ctrlKey) {
                ...
                n && (t(e.target).attr("tabIndex", -1), t(n).attr("tabIndex", 0), n.focus(), e.preventDefault())
            }
        },
        ...
        _refresh: function () {
            var i, s = this.options, o = s.heightStyle, n = this.element.parent(), r = this.accordionId = "ui-accordion-" + (this.element.attr("id") || ++e);
            this.active = this._findActive(s.active).addClass("ui-accordion-header-active ui-state-active ui-corner-top").removeClass("ui-corner-all"), this.active.next().addClass("ui-accordion-content-active").show(), this.headers.attr("role", "tab").each(function (e) {
                var i = t(this), s = i.attr("id"), o = i.next(), n = o.attr("id");
                s || (s = r + "-header-" + e, i.attr("id", s)), n || (n = r + "-panel-" + e, o.attr("id", n)), i.attr("aria-controls", n), o.attr("aria-labelledby", s)
                ...
                "aria-expanded": "true",
                tabIndex: 0
            }).next().attr({"aria-hidden": "false"}) : this.headers.eq(0).attr("tabIndex", 0), this._createIcons(), this._setupEvents(s.event), "fill" === o ? (i = n.height(), this.element.siblings(":visible").each(function () {
        ...
        _eventHandler: function (e) {
            var i = this.options, s = this.active, o = t(e.currentTarget), n = o[0] === s[0], r = n && i.collapsible, a = r ? t() : o.next(), l = s.next(), h = {
                oldHeader: s,
                oldPanel: l,
                newHeader: r ? t() : o,
                newPanel: a
        ...
        _animate: function (t, e, o) {
            var n, r, a, l = this, h = 0, c = t.length && (!e.length || t.index() < e.index()), p = this.options.animate || {}, d = c && p.down || p, f = function () {
                l._toggleComplete(o)
            };
            return "number" == typeof d && (a = d), "string" == typeof d && (r = d), r = r || d.easing || p.easing, a = a || d.duration || p.duration, e.length ? t.length ? (n = t.show().outerHeight(), e.animate(i, {
                duration: a,
                easing: r,
                step: function (t, e) {
                    e.now = Math.round(t)
                ...
                duration: a, easing: r, complete: f, step: function (t, i) {
                    i.now = Math.round(t), "height" !== i.prop ? h += i.now : "content" !== l.options.heightStyle && (i.now = Math.round(n - e.outerHeight() - h), h = 0)
                }
            }), undefined) : e.animate(i, a, r, f) : t.animate(s, a, r, f)
        },
...
(function (t) {
    t.widget("ui.autocomplete", {
        ...
        pending: 0,
        _create: function () {
            var e, i, s, o = this.element[0].nodeName.toLowerCase(), n = "textarea" === o, r = "input" === o;
...
(function (t) {
    var e, i = "ui-button ui-widget ui-state-default ui-corner-all", s = "ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon-primary ui-button-text-icon-secondary ui-button-text-only", o = function () {
        var e = t(this);
        setTimeout(function () {
            e.find(":ui-button").button("refresh")
        }, 1)
    }, n = function (e) {
        var i = e.name, s = e.form, o = t([]);
        return i && (i = i.replace(/'/g, "\\'"), o = s ? t(s).find("[name='" + i + "']") : t("[name='" + i + "']", e.ownerDocument).filter(function () {
            return !this.form
        })), o
    };
    t.widget("ui.button", {
        ...
        _create: function () {
            ...
            var s = this, r = this.options, a = "checkbox" === this.type || "radio" === this.type, l = a ? "" : "ui-state-active";
            null === r.label && (r.label = "input" === this.type ? this.buttonElement.val() : this.buttonElement.html()), this._hoverable(this.buttonElement), this.buttonElement.addClass(i).attr("role", "button").bind("mouseenter" + this.eventNamespace, function () {
                ...
                var e = s.element[0];
                n(e).not(e).map(function () {
                    return t(this).button("widget")[0]
                }).removeClass("ui-state-active").attr("aria-pressed", "false")
            }) : (this.buttonElement.bind("mousedown" + this.eventNamespace, function () {
                return r.disabled ? !1 : (t(this).addClass("ui-state-active"), e = this, s.document.one("mouseup", function () {
                    e = null
                }), undefined)
        ...
        refresh: function () {
            ...
            e !== this.options.disabled && this._setOption("disabled", e), "radio" === this.type ? n(this.element[0]).each(function () {
                t(this).is(":checked") ? t(this).button("widget").addClass("ui-state-active").attr("aria-pressed", "true") : t(this).button("widget").removeClass("ui-state-active").attr("aria-pressed", "false")
            }) : "checkbox" === this.type && (this.element.is(":checked") ? this.buttonElement.addClass("ui-state-active").attr("aria-pressed", "true") : this.buttonElement.removeClass("ui-state-active").attr("aria-pressed", "false"))
        },
        _resetButton: function () {
            if ("input" === this.type)return this.options.label && this.element.val(this.options.label), undefined;
            var e = this.buttonElement.removeClass(s), i = t("<span></span>", this.document[0]).addClass("ui-button-text").html(this.options.label).appendTo(e.empty()).text(), o = this.options.icons, n = o.primary && o.secondary, r = [];
            o.primary || o.secondary ? (this.options.text && r.push("ui-button-text-icon" + (n ? "s" : o.primary ? "-primary" : "-secondary")), o.primary && e.prepend("<span class='ui-button-icon-primary ui-icon " + o.primary + "'></span>"), o.secondary && e.append("<span class='ui-button-icon-secondary ui-icon " + o.secondary + "'></span>"), this.options.text || (r.push(n ? "ui-button-icons-only" : "ui-button-icon-only"), this.hasTitle || e.attr("title", t.trim(i)))) : r.push("ui-button-text-only"), e.addClass(r.join(" "))
        }
...
(function (t, e) {
    ...
    t.extend(i.prototype, {
        ...
        parseDate: function (i, s, n) {
            ...
            for (o = 0; i.length > o; o++)if (y)"'" !== i.charAt(o) || w("'") ? x() : y = !1; else switch (i.charAt(o)) {
                case"d":
                    _ = k("d");
                    break;
                case"D":
                ...
                case"y":
                    ...
                    break;
                case"@":
                    l = new Date(k("@")), m = l.getFullYear(), v = l.getMonth() + 1, _ = l.getDate();
                    break;
                case"!":
                    l = new Date((k("!") - this._ticksTo1970) / 1e4), m = l.getFullYear(), v = l.getMonth() + 1, _ = l.getDate();
                    break;
                case"'":
                    w("'") ? x() : y = !0;
                    break;
    ...
    t.widget("ui.tabs", {
        ...
        _processTabs: function () {
            ...
            this.tablist = this._getList().addClass("ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all").attr("role", "tablist"), this.tabs = this.tablist.find("> li:has(a[href])").addClass("ui-state-default ui-corner-top").attr({
                ...
                s(n) ? (o = n.hash, a = e.element.find(e._sanitizeSelector(o))) : (r = e._tabId(h), o = "#" + r, a = e.element.find(o), a.length || (a = e._createPanel(r), a.insertAfter(e.panels[i - 1] || e.tablist)), a.attr("aria-live", "polite")), a.length && (e.panels = e.panels.add(a)), c && h.data("ui-tabs-aria-controls", c), h.attr({
        ...
        load: function (e, i) {
            e = this._getIndex(e);
            var n = this, o = this.tabs.eq(e), a = o.find(".ui-tabs-anchor"), r = this._getPanelForTab(o), l = {
                tab: o,
                panel: r
            };
...
(function (t) {
    ...
    t.effects.effect.blind = function (s, n) {
        var o, a, r, l = t(this), h = ["position", "top", "bottom", "left", "right", "height", "width"], c = t.effects.setMode(l, s.mode || "hide"), u = s.direction || "up", d = e.test(u), p = d ? "height" : "width", f = d ? "top" : "left", g = i.test(u), m = {}, v = "show" === c;
        l.parent().is(".ui-effects-wrapper") ? t.effects.save(l.parent(), h) : t.effects.save(l, h), l.show(), o = t.effects.createWrapper(l).css({overflow: "hidden"}), a = o[p](), r = parseFloat(o.css(f)) || 0, m[p] = v ? a : 0, g || (l.css(d ? "bottom" : "right", 0).css(d ? "top" : "left", "auto").css({position: "absolute"}), m[f] = v ? r : a + r), v && (o.css(p, 0), g || o.css(f, r + a)), o.animate(m, {
            duration: s.duration,
            easing: s.easing,
            queue: !1,
            complete: function () {
...
(function (t) {
    t.effects.effect.bounce = function (e, i) {
        var s, n, o, a = t(this), r = ["position", "top", "bottom", "left", "right", "height", "width"], l = t.effects.setMode(a, e.mode || "effect"), h = "hide" === l, c = "show" === l, u = e.direction || "up", d = e.distance, p = e.times || 5, f = 2 * p + (c || h ? 1 : 0), g = e.duration / f, m = e.easing, v = "up" === u || "down" === u ? "top" : "left", _ = "up" === u || "left" === u, b = a.queue(), y = b.length;
        for ((c || h) && r.push("opacity"), t.effects.save(a, r), a.show(), t.effects.createWrapper(a), d || (d = a["top" === v ? "outerHeight" : "outerWidth"]() / 3), c && (o = {opacity: 1}, o[v] = 0, a.css("opacity", 0).css(v, _ ? 2 * -d : 2 * d).animate(o, g, m)), h && (d /= Math.pow(2, p - 1)), o = {}, o[v] = 0, s = 0; p > s; s++)n = {}, n[v] = (_ ? "-=" : "+=") + d, a.animate(n, g, m).animate(o, g, m), d = h ? 2 * d : d / 2;
...
(function (t) {
    t.effects.effect.explode = function (e, i) {
        ...
        var o, a, r, l, h, c, u = e.pieces ? Math.round(Math.sqrt(e.pieces)) : 3, d = u, p = t(this), f = t.effects.setMode(p, e.mode || "hide"), g = "show" === f, m = p.show().css("visibility", "hidden").offset(), v = Math.ceil(p.outerWidth() / d), _ = Math.ceil(p.outerHeight() / u), b = [];
        for (o = 0; u > o; o++)for (l = m.top + o * _, c = o - (u - 1) / 2, a = 0; d > a; a++)r = m.left + a * v, h = a - (d - 1) / 2, p.clone().appendTo("body").wrap("<div></div>").css({
            position: "absolute",
            visibility: "visible",
            left: -a * v,
            top: -o * _
...
(function (t) {
    t.effects.effect.fold = function (e, i) {
        var s, n, o = t(this), a = ["position", "top", "bottom", "left", "right", "height", "width"], r = t.effects.setMode(o, e.mode || "hide"), l = "show" === r, h = "hide" === r, c = e.size || 15, u = /([0-9]+)%/.exec(c), d = !!e.horizFirst, p = l !== d, f = p ? ["width", "height"] : ["height", "width"], g = e.duration / 2, m = {}, v = {};
...
(function (t) {
    t.effects.effect.puff = function (e, i) {
        var s = t(this), o = t.effects.setMode(s, e.mode || "hide"), n = "hide" === o, a = parseInt(e.percent, 10) || 150, r = a / 100, l = {
            height: s.height(),
            width: s.width(),
        ...
        var s = t(this), o = t.extend(!0, {}, e), n = t.effects.setMode(s, e.mode || "effect"), a = parseInt(e.percent, 10) || (0 === parseInt(e.percent, 10) ? 0 : "hide" === n ? 0 : 100), r = e.direction || "both", l = e.origin, h = {
            height: s.height(),
            width: s.width(),
            outerHeight: s.outerHeight(),
            outerWidth: s.outerWidth()
        }, c = {y: "horizontal" !== r ? a / 100 : 1, x: "vertical" !== r ? a / 100 : 1};
        o.effect = "size", o.queue = !1, o.complete = i, "effect" !== n && (o.origin = l || ["middle", "center"], o.restore = !0), o.from = e.from || ("show" === n ? {
                height: 0,
                width: 0,
                outerHeight: 0,
                outerWidth: 0
        ...
        }, o.fade && ("show" === n && (o.from.opacity = 0, o.to.opacity = 1), "hide" === n && (o.from.opacity = 1, o.to.opacity = 0)), s.effect(o)
    }, t.effects.effect.size = function (e, i) {
        var s, o, n, a = t(this), r = ["position", "top", "bottom", "left", "right", "width", "height", "overflow", "opacity"], l = ["position", "top", "bottom", "left", "right", "overflow", "opacity"], h = ["width", "height", "overflow"], c = ["fontSize"], u = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"], d = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"], p = t.effects.setMode(a, e.mode || "effect"), f = e.restore || "effect" !== p, g = e.scale || "both", m = e.origin || ["middle", "center"], v = a.css("position"), _ = f ? r : l, b = {
            height: 0,
            width: 0,
            outerHeight: 0,
            outerWidth: 0
        ...
        "show" === p && a.show(), s = {
        ...
        }, "toggle" === e.mode && "show" === p ? (a.from = e.to || b, a.to = e.from || s) : (a.from = e.from || ("show" === p ? b : s), a.to = e.to || ("hide" === p ? b : s)), n = {
            from: {
                y: a.from.height / s.height,
                x: a.from.width / s.width
            }, to: {y: a.to.height / s.height, x: a.to.width / s.width}
        }, ("box" === g || "both" === g) && (n.from.y !== n.to.y && (_ = _.concat(u), a.from = t.effects.setTransition(a, u, n.from.y, a.from), a.to = t.effects.setTransition(a, u, n.to.y, a.to)), n.from.x !== n.to.x && (_ = _.concat(d), a.from = t.effects.setTransition(a, d, n.from.x, a.from), a.to = t.effects.setTransition(a, d, n.to.x, a.to))), ("content" === g || "both" === g) && n.from.y !== n.to.y && (_ = _.concat(c).concat(h), a.from = t.effects.setTransition(a, c, n.from.y, a.from), a.to = t.effects.setTransition(a, c, n.to.y, a.to)), t.effects.save(a, _), a.show(), t.effects.createWrapper(a), a.css("overflow", "hidden").css(a.from), m && (o = t.effects.getBaseline(m, s), a.from.top = (s.outerHeight - a.outerHeight()) * o.y, a.from.left = (s.outerWidth - a.outerWidth()) * o.x, a.to.top = (s.outerHeight - a.to.outerHeight) * o.y, a.to.left = (s.outerWidth - a.to.outerWidth) * o.x), a.css(a.from), ("content" === g || "both" === g) && (u = u.concat(["marginTop", "marginBottom"]).concat(c), d = d.concat(["marginLeft", "marginRight"]), h = r.concat(u).concat(d), a.find("*[width]").each(function () {
            var i = t(this), s = {
                height: i.height(),
                width: i.width(),
            ...
            }, n.from.y !== n.to.y && (i.from = t.effects.setTransition(i, u, n.from.y, i.from), i.to = t.effects.setTransition(i, u, n.to.y, i.to)), n.from.x !== n.to.x && (i.from = t.effects.setTransition(i, d, n.from.x, i.from), i.to = t.effects.setTransition(i, d, n.to.x, i.to)), i.css(i.from), i.animate(i.to, e.duration, e.easing, function () {
            ...
            queue: !1, duration: e.duration, easing: e.easing, complete: function () {
                0 === a.to.opacity && a.css("opacity", a.from.opacity), "hide" === p && a.hide(), t.effects.restore(a, _), f || ("static" === v ? a.css({
                    ...
                    a.css(e, function (e, i) {
                        var s = parseInt(i, 10), o = t ? a.to.left : a.to.top;
                        return "auto" === i ? o + "px" : s + o + "px"
                    })
...
(function (t) {
    t.effects.effect.shake = function (e, i) {
        var s, o = t(this), n = ["position", "top", "bottom", "left", "right", "height", "width"], a = t.effects.setMode(o, e.mode || "effect"), r = e.direction || "left", l = e.distance || 20, h = e.times || 3, c = 2 * h + 1, u = Math.round(e.duration / c), d = "up" === r || "down" === r ? "top" : "left", p = "up" === r || "left" === r, f = {}, g = {}, m = {}, v = o.queue(), _ = v.length;
        for (t.effects.save(o, n), o.show(), t.effects.createWrapper(o), f[d] = (p ? "-=" : "+=") + l, g[d] = (p ? "+=" : "-=") + 2 * l, m[d] = (p ? "-=" : "+=") + 2 * l, o.animate(f, u, e.easing), s = 1; h > s; s++)o.animate(g, u, e.easing).animate(m, u, e.easing);
        o.animate(g, u, e.easing).animate(f, u / 2, e.easing).queue(function () {
            "hide" === a && o.hide(), t.effects.restore(o, n), t.effects.removeWrapper(o), i()
        }), _ > 1 && v.splice.apply(v, [1, 0].concat(v.splice(_, c + 1))), o.dequeue()
    }
})(jQuery);
(function (t) {
    t.effects.effect.slide = function (e, i) {
        var s, o = t(this), n = ["position", "top", "bottom", "left", "right", "width", "height"], a = t.effects.setMode(o, e.mode || "show"), r = "show" === a, l = e.direction || "left", h = "up" === l || "down" === l ? "top" : "left", c = "up" === l || "left" === l, u = {};
        t.effects.save(o, n), o.show(), s = e.distance || o["top" === h ? "outerHeight" : "outerWidth"](!0), t.effects.createWrapper(o).css({overflow: "hidden"}), r && o.css(h, c ? isNaN(s) ? "-" + s : -s : s), u[h] = (r ? c ? "+=" : "-=" : c ? "-=" : "+=") + s, o.animate(u, {
            queue: !1,
            duration: e.duration,
            easing: e.easing,
            complete: function () {
...
(function (t) {
    t.effects.effect.transfer = function (e, i) {
        var s = t(this), o = t(e.to), n = "fixed" === o.css("position"), a = t("body"), r = n ? a.scrollTop() : 0, l = n ? a.scrollLeft() : 0, h = o.offset(), c = {
            top: h.top - r,
            left: h.left - l,
