...
draw2d.Task = function() {
	...
	this.candidateUsersType=null;
	this.signUsersType=null;
	this.copySendUsersType=null;
	this.isUseExpression=false;
	this.assigneeExpression=null;
	this.candidateUsersExpression=null;
	this.signUsersExpression=null;
	this.copySendUsersExpression=null;
	this.formKey = null;
...
draw2d.Task.prototype.generateId=function(){
	...
	this.setContent($.trim(this.taskName));
};
//双击流程元素打开属性页面
