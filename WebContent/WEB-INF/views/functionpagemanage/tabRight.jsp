...
<div id="formSettingCondition" class="tab-pane">
	...
	<!-- 开始 - columnproperties -->
		...
		<div>
			...
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;全局属性</a></div>
			<div class="quality_contern"  id="globalProperty4"></div>
			
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;控件组属性</a></div>
			<div class="quality_contern" id="globalProperty8">
				
			</div>

			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;页面块属性</a></div>
			<div class="quality_contern" id="globalProperty10">
				
			</div>
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;时间选值范围关联</a></div>
			<div class="quality_contern" id="globalProperty9">
				
			</div>
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;基本属性</a></div>
			<div class="quality_contern" id="baseConfigProperty"></div>

			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;选人数据源</a></div>
			<div class="quality_contern" id="globalProperty6">
				
			</div>
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;选人范围</a></div>
			<div class="quality_contern" id="globalProperty7">
				
			</div>

			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;添加控件验证</a></div>
			<div class="quality_contern"  id="validatorControl"></div>


			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;数据源</a></div>
			<div class="quality_contern" id="dataSource"></div>

			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;选择显示控件</a></div>
			<div class="quality_contern"  id="isShowControlFunc"></div>

			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-down"></i>&nbsp;&nbsp;加载控件数据</a></div>
			<div class="quality_contern"  id="setControlData"></div>




			<!-- <div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;控件样式</a></div>
			<div class="quality_contern" id="controlCSS"> 
			...
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;表单标题</a></div>
			<div class="quality_contern" id="globalProperty3">
				
			</div>
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;页面按钮</a></div>
			<div class="quality_contern" id="globalProperty">
				
			</div>
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;页面显示方式</a></div>
			<div class="quality_contern" id="globalProperty2">
				
			</div>
			
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;页面加载事件</a></div>
			<div class="quality_contern" id="globalProperty5">
				
			</div>
			
			
			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;表格属性</a></div>
			<div class="quality_contern" id="tableProperty"></div>

			<div class="quality"><a href="javascript: void(0);"><i class="fa fa-caret-right"></i>&nbsp;&nbsp;控件事件--<small style="color: #777; font-weight: 400;">导入js得到方法</small></a></div>
			<div class="quality_contern" id="controlEvent"></div>
...
<div id="updateFormTempDiv" style="display: none"></div>
<select id="jsselect"  style="display: none">
	<c:forEach items="${js }" var="v">
		<option value="">${v.funNames }</option>
	</c:forEach>
