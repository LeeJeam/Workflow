				...
				<div class="col-md-offset-2 col-md-8">
					<div id="msform">
						...
						<div class="menu">
							...
							<form id="defaultForm" method="post" action="" class="form-horizontal">
			                    <fieldset>
			                        ...
			                        <div class="form-group">
			                            ...
			                            <div class="col-lg-10">
											<div id="showImg">
												<input type = "hidden" id="templateType" value="1"/>
												<a href="javascript: void(0);" data-toggle="modal" data-target="#myModal" class="Template"><img src="<%=rootPath %>/images/Template1/Template1.png"></a>
											</div>
							...
							<a href="javascript: void(0);" class="btn bg-blue margin next action-button fr" onclick="foreword(this)">下一步</a>
							<div class="cler"></div>
						</div>
						<div class="menu">
	    ...
	    <div class="modal-dialog" role="document">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	                <ol style=" line-height: 24px;" id="projectUI">
						<a href="javascript: void(0);" data-toggle="modal" data-target="#myModal" class="Template">
							<input type = "hidden" id="templateType" value="4"/>
							<img src="<%=rootPath %>/images/Template1/Template2.png">
						</a>
					</ol>
	            </div>
...
<script src="<%=rootPath %>/js/custom/views/functionpagemanage/submenu-shop-system.js"></script>
<script type="text/javascript">
  paramJSON.type="${param.type}";
  var projectId="<%=project.getId()%>";
  paramJSON.projetcId=projectId;
  paramJSON.templetName="table-view";
  $("#imgSave").click(function () {
	  switchTemplate(true)
  });

  $('#projectUI').delegate('a', 'click', function () {
	  switchTemplate()
  });

  function switchTemplate(flag) {
	  var img1 = $('#projectUI').html();
	  var img2 = $('#showImg').html();
	  $('#showImg').empty().html(img1);
	  $('#projectUI').empty().html(img2);

	  var type = $('#showImg').find("#templateType").val();
	  paramJSON.type = type;
	  if(!!flag) {
		  $('#imgreset').click();
	  }
