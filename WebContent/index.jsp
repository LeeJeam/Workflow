		      ...
		      <div class="header_top">
			      <div class="header-left">
					 <div class="logo wow bounceInDown" data-wow-delay="0.4s">
						<a href="#" style="font-size: 38px; color: #fff; width: 100%;"><b>FLOWSys</b><br><p>项目流程快速开发框架</p></a>
					 </div>
			   ...
			   <div class="header_bottom">
			   	  <h1 class="m_head wow rollIn" data-wow-delay="0.4s" style="font-size: 26px;">多类模块 超越想像</h1>
			   	  <p class="m_head wow rollIn" data-wow-delay="0.4s" style="color: #fff; font-family: 'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif;">主从表单、EXCEL式表单、工作流、<br>普通报表、交叉报表、标题列表、图文列表、<br>树、图表分析、常用筛选、搜索查询……应有尽有，随时满足个性需求！</p>
		            ...
		            <div class="modal-body">
		                <label>项目名称</label>
		                  	...
		                  	<div class="form-group">
								<div class="checkbox">
		                            <label>
		                                <input class="item1input" type="checkbox" name="step1TrainedUserRole" value="1" /> 是否需要登录界面
		                            </label>
		                            <label style="margin-left: 30px;">
		                                <input type="checkbox" class="item1input" name="step1TrainedUserRole" value="2" /> 是否需要用户管理
		                            </label>
		                            <label style="margin-left: 30px;">
		                                <input type="checkbox" class="item1input" name="step1TrainedUserRole" value="3" /> 是否需要系统配置
		                            </label>
		                        </div>
		                  	</div>
