...
$(function() {
			...
			_line_listener_fields_dg = $('#line-listeners-fields-list')
					.datagrid({
						// title:"Listener",
						...
						toolbar : [{
							...
							handler : function() {
								...
								$('#line-listeners-fields-list').datagrid(
										'appendRow', {
											id : '',
											fieldName : '',
											type : '',
								...
								var index = $('#line-listeners-fields-list')
...
function getListenerFieldsGridChangeRows() {
	...
	var insertRows = _line_listener_fields_dg
...
function populateListenerProperties() {
	if (listenerId != "" && listenerId != null && listenerId != "null"
		...
		_line_listener_fields_dg.datagrid('loadData',
...
<table>
	...
	<tr>
		<td colspan="2" align="center"><a href="##" id="fieldSaveBt" onclick="saveListenerConfig()">Save</a> <a href="##" id="fieldCancelBt" onclick="closeLineListenerWin()">Cancel</a></td>
	</tr>
</table>
