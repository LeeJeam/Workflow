                ...
                <div id="searchdiv" class="col-md-8" style="padding-left: 5px; padding-right: 5px;">
                    <c:if test="${empty content}">
                        ...
                        <div class="box box-primary" style="margin-bottom: 5px;">
                            <div class="box-header with-border">
                                ...
                                <div id="pageBtn" class="box-tools pull-right">
                                    ...
                                    <button onclick="TableControl.deleteLabel()" id="removeMenu" class="btn btn-primary btn-sm" type="button">删除</button>
                                </div>
                            </div>
                        ...
                        <div id="tableContent" class="box box-primary" style="margin-bottom: 0px;">
                            ...
                            <div class="box-body">
                                <input type="hidden" id="recodetable_0" name="recodetable"/>
                        ...
                        <div class="box-body" id="conternbodyRight" style="overflow-y: auto; overflow-x: hidden;">
                            ...
                            <div class="quality_contern" id="pageBtnSet">
                                <div>
                                    ...
                                    <div class="checkbox search_btn " style="margin-top: 5px;">
                                        <label class="col-md-4">
                                            <input value="edit" class="rightClick" ref="edit"  type="checkbox" id="edit" click="pop"/> 修改
                                        </label>
                                        <label class="col-md-4">
                                ...
                                <div>
                                    ...
                                    <div class="checkbox search_btn " style="margin-top: 5px;">
                                        <label class="col-md-4">
                                            <input value="edit" class="dataBtn" ref="data_edit"  type="checkbox" id="data_edit" click="pop"/> 修改
                                        </label>
                                        <label class="col-md-4">
                                            <input value="delete" class="dataBtn" ref="data_delete" type="checkbox" id="data_delete"/> 删除
                                        </label>
                                        <label class="col-md-4">
                                            <input value="isView" class="dataBtn" ref="data_isView" type="checkbox" id="data_isView" click="pop"/> 详情
                                        </label>
                                    </div>
                                </div>
                            </div>
