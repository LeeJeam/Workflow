...
package cn.hy.commForm.controller.tool;
...
public class JarClassFileLoader extends ClassLoader {
	   //上传文件保存的根目录
	   ...
	   //读取文件的路径
	   public static final String drive=gPath+"\\cn\\hy\\commForm\\pojo\\";
	   //读取文件的类型
	   public static final String fileType=".class";
	   //类名
	   public static final String className="CRunImport";
	   //类文件的全名
	   public static final String packgeName="cn.hy.commForm.pojo."+className;
	   //类的方法名
	    ...
	    */
	    public static void runClassMethod(String jarnamepath) throws InstantiationException, IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException{
			...
			if(f.exists()){
				boolean b = JarClassFileLoader.deleteFolder(targetJarPath);
