...
public class MediaHelper {
	...
	public static MediaUploadResult upload(String accessToken, String type,
			File file) throws OApiException {
		String url = Env.OAPI_HOST + "/media/upload?" + "access_token="
		...
		if (!response.containsKey("type") || !response.containsKey("media_id")
			...
			return JSON.parseObject(response.toJSONString(),
	...
	public static void download(String accessToken, String mediaId,
			String fileDir) throws OApiException {
		String url = Env.OAPI_HOST + "/media/get?" + "access_token="
