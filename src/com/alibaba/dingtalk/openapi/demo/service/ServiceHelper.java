...
public class ServiceHelper {
	...
	public static String getPermanentCode(String tmp_auth_cod,
		...
		try {
			reponseJson = HttpHelper.httpPost(url, json);
			permanentCode = reponseJson.getString("permanent_code");
		} catch (OApiException e) {
			e.printStackTrace();
		}
	...
	public static String getCorpToken(String auth_corpid,
			String permanent_code, String suiteAccessToken) {
		String url = Env.OAPI_HOST
