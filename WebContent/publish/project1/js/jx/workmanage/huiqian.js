...
function getTableData(){
	dt=$('#dataTable').dataTable( {		
		...
		scrollX: true,
		ajax:{  
            url: basePath+'/myWork/jointlySign.htm',
            type:"POST",
            dataSrc: "aaData",
            data: function ( d ) {
            	var param={};
		...
		columns: [
			...
			{ "data": "id","mRender": function(data,type,full){
				return '<div class="action-buttons"><a class="btn btn-primary btn-xs btn-flat" onclick="accountant(\''+data+'\',\''+full.taskId+'\',\'1\')" title="会签">会签</a>'
